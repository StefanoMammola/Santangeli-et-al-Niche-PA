...
db <- read.csv("Data/hypervolume_metrics_16_11_21.csv", header = TRUE, sep = ",", dec = ".", row.names = NULL, as.is = FALSE)

# Read Trait matrix
trait <- read.csv("Data/traits17_11_21.csv", header = TRUE, sep = ",", dec = ".", row.names = NULL, as.is = FALSE)
...
pdf("Figures/new_Figure_S3.pdf", width = 10, height = 4)
...
pdf(file = "Figures/new_Figure 5.pdf", width = 12, height = 10)
...
pdf("Figures/new_Figure_S4.pdf", width = 8, height = 4)
s4
dev.off()
...
#Save the plot
pdf(file = "Figures/new Figure 4.pdf", width = 8, height = 4)
p2 + theme_tree2()
dev.off()
...
pdf(file = "Figures/new Figure 3.pdf", width = 10, height = 10)
p4 + theme_tree2()
dev.off()
...
pdf(file = "Figures/new Figure 2.pdf", width = 10, height = 3)
